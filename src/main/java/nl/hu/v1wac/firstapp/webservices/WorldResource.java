...
public class WorldResource {
	...
	public String updateCountry(@PathParam("updatecode") String code, @FormParam("nameUpdate") String name,
			@FormParam("iso2Update") String iso2, @FormParam("capitalUpdate") String capital,
			@FormParam("continentUpdate") String continent, @FormParam("regionUpdate") String region,
			@FormParam("surfaceUpdate") Double surface, @FormParam("populationUpdate") Integer population,
			@FormParam("governmentUpdate") String government, @FormParam("latUpdate") Double lat,
			@FormParam("lngUpdate") Double lng) {

		Country newCountry = new Country(iso2, code, name, capital, continent, region, surface, population, government,
				lat, lng);
	...
	@Path("{iso3}")
	@Produces("application/json")
	public String deleteCountry(@PathParam("iso3") String code, @FormParam("nameUpdate") String name,
			@FormParam("iso2Update") String iso2, @FormParam("capitalUpdate") String capital,
			@FormParam("continentUpdate") String continent, @FormParam("regionUpdate") String region,
			@FormParam("surfaceUpdate") Double surface, @FormParam("populationUpdate") Integer population,
			@FormParam("governmentUpdate") String government, @FormParam("latUpdate") Double lat,
	...
	public String createCountry(@FormParam("code") String code, @FormParam("name") String name,
			@FormParam("iso2") String iso2, @FormParam("capital") String capital,
			@FormParam("continent") String continent, @FormParam("region") String region,
			@FormParam("surface") Double surface, @FormParam("population") Integer population,
			@FormParam("government") String government, @FormParam("lat") Double lat, @FormParam("lng") Double lng) {
		Country newCountry = new Country(iso2, code, name, capital, continent, region, surface, population, government,
				lat, lng);
